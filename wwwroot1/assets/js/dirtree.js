        ...
        eBox.off('click').on('click', function(e) {
            ...
            if (eTag.is('#J_CreateCancel, #J_CreateCancel *')) {
                ...
                if (eTag.hasClass("_minus")) { // has children and has open
                    eTag.removeClass('_minus').find('.plus:eq(0)').addClass('glyphicon-plus').removeClass('glyphicon-minus');
                } else { // list children
                    eTag.addClass("_minus").find('.plus:eq(0)').addClass('glyphicon-minus').removeClass('glyphicon-plus');
