 ...
 */
public class MyPhoneAdapter extends BaseAdapter implements Filterable {
    private int[] mTo;
     ...
     */
    public MyPhoneAdapter(Context context, List<? extends Map<String, ?>> data,
     ...
     *
     * @see MyPhoneAdapter#setViewImage(ImageView, int)
     * @see MyPhoneAdapter#setViewImage(ImageView, String)
     * @see MyPhoneAdapter#setViewText(TextView, String)
     */
