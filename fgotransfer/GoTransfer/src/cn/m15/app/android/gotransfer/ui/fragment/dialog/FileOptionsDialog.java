...
import cn.m15.app.android.gotransfer.ui.activity.ConversationActivity;
...
public class FileOptionsDialog extends CommonDialogFragment
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (activity != null && !activity.isFinishing()) {
			...
			case 0:
				...
				break;
			case 1:
				deleteFile((ConversationActivity) activity, mPacketNo, mFilePath);
				break;
			case 2:
	...
	private static boolean deleteFile(ConversationActivity activity, long packetNo, String filePath) {
		File file = new File(filePath);
		if (file.exists()) {
			file.delete();
			// if you want to delete a file, please add the follow code:
			activity.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(file)));
			TransferDBHelper.deleteTransferRecord(activity, packetNo, filePath, activity);
