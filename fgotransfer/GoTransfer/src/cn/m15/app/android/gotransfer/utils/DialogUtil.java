...
public class DialogUtil {
	...
	public static final String DIALOG_QUIT_APP = "dialog_quit_app";
	...
	public static void showCloseConnectionDialog(FragmentActivity activity) {
		...
		params.btnLeftText = activity.getString(R.string.cancel);
	...
	public static void showClearSelectedFilesDialog(FragmentActivity activity) {
		...
		TransferFileManager transferFilesManager = TransferFileManager.getInstance();
		...
		params.contentText = String.format(
				...
				transferFilesManager.size());
		params.btnLeftText = activity.getString(R.string.cancel);
		params.btnRightText = activity.getString(R.string.ok);
		params.textGravity = Gravity.CENTER;
		params.canceledOnTouchOutside = false;
		CommonDialogFragment dialog = new CommonDialogFragment();
		dialog.setParams(params);
	...
	public static void showChangeNameDialog(FragmentActivity activity) {
		...
		params.btnLeftText = activity.getString(R.string.cancel);
		params.btnRightText = activity.getString(R.string.confirm);
		dialog.setParams(params);
		dialog.show(activity);
	...
	@Deprecated
	public static void showCancelTransferDialog(FragmentActivity activity, TUser user,
		...
		params.btnLeftText = activity.getString(R.string.transfer_continue);
		params.btnRightText = activity.getString(R.string.confirm);
		params.textGravity = Gravity.CENTER;
		params.canceledOnTouchOutside = false;
	...
	public static void showNotEnoughSpaceDialog(FragmentActivity activity, TUser user,
			String packetNo) {
		DialogParams params = new DialogParams();
	...
	public static FileOptionsDialog showFileOptionsDialog(FragmentActivity activity, long packetNo, String filePath) {
		DialogParams params = new DialogParams();
		...
		args.putLong("packet_no", packetNo);
	...
	public static void showQuitAppDialog(FragmentActivity activity) {
		DialogParams params = new DialogParams();
		params.tag = DIALOG_QUIT_APP;
		params.btnLeftText = activity.getString(R.string.cancel);
		params.btnRightText = activity.getString(R.string.quit);
		params.contentText = activity.getString(R.string.quit_app_or_not);
