...
public class UmConversationActivity extends Activity {
	private static final String TAG = UmConversationActivity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Button btnCall=(Button) findViewById(R.id.umeng_fb_call);
			btnCall.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					intent.setClass(UmConversationActivity.this,
	...
	class ReplyListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == 0) {
				// 自定义提示内容
				reply = createInitDevReply(getResources().getString(R.string.umeng_fb_reply_content_default));
			} else {
