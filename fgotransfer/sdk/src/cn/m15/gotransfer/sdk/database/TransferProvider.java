...
import cn.m15.gotransfer.sdk.database.Transfer.User;
...
public class TransferProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		LogManager.d(TAG, "query >>> " + selection + ", " + Arrays.toString(selectionArgs));
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		LogManager.d(TAG, "insert >>> " + initialValues);
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		LogManager.d(TAG, "delete >>> " + where + ", " + Arrays.toString(whereArgs));
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
		LogManager.d(TAG, "update >>> " + where + ", " + Arrays.toString(whereArgs));
	...
	public ContentProviderResult[] applyBatch(ArrayList<ContentProviderOperation> operations)
		...
		LogManager.d("Conversation", "applyBatch >>> " + operations.size());
	    ...
	    try {
	    	...
	    	LogManager.e(TAG, "batch failed: " + e.getLocalizedMessage());
	    } finally {
	        db.endTransaction();
	        isNotifyChange = true;
	    }
